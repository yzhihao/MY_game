...
test['UID']=operation_test['UID']
train['UID']=operation_trn['UID']

train.to_csv('stacking_fea_op_pre.csv',index=False)
test.to_csv('stacking_fea_op_test_pre.csv',index=False)
